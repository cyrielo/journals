...
import { View, Text, ImageBackground, DimensionValue, StyleSheet, ImageSourcePropType, ViewStyle } from 'react-native';
...
const ReflectionCard = ({ title, style, description, media = [], isBookMarked, date }: ReflectionCardProps): React.JSX.Element =>  {
      ...
      <View style={{
        ...
        <View style={{
          ...
          {mediaLen > 2 ? (
              ...
              <View style={{
                ...
                {altMedia.map((item, idx) => {
                  if (idx < 2 && (altMedia.length) == 2) {
                    return (
                      <View key={idx} style={{ height: 70, width: '100%' }}>
                        <ImageBackground
                          style={{
                            height: '100%',
                            width: 'auto',
                  ...
                  if (idx == 2 && (altMedia.length - 1) == (idx)) {
                    return (
                      <View key={idx} style={{ height: 75, width: '100%' }}>
                        <ImageBackground
                          style={{
                            height: '100%',
                            width: 'auto',
                  ...
                  if (idx == 3 && remaining > 0) {
                    return (
                      <View key={idx} style={{ height: 70, width: '48%' }}>
                        <View style={{
                          position: 'absolute',
                          zIndex: 10,
                          height: '100%',
            ...
            return (
              <View style={{ height: 150, width: mediaLen == 1 ? '100%' : '49%' }}>
                <ImageBackground
                  style={{
                    height: '100%',
                    width: 'auto',
